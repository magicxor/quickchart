...
// chartjs-chart-funnel labels a stage "<name>\n<value * 100>%", which reads
// correctly only for data given as fractions of 1 - absolute stage counts come
// out as "60,000%". Dropping its formatter hands funnels to the one above,
// which names the stage and prints the value as the caller gave it.
delete Chart.overrides.funnel.plugins.datalabels.formatter;
