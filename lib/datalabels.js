...
// own key listing, minus the members that are themselves objects - those are
// exactly what renders as "[object Object]".
function describePrimitives(value) {
  const parts = Object.keys(value)
    .filter((key) => isPresent(value[key]) && typeof value[key] !== 'object')
